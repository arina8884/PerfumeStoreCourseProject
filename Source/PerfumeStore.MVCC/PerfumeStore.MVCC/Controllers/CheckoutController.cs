...
public class CheckoutController : Controller
{
    ...
    {
        var model = await _checkoutService.GetCheckoutAsync(GetCurrentUserId());
    ...
    {
        var checkout = await _checkoutService.GetCheckoutAsync(GetCurrentUserId());
    ...
    public async Task<IActionResult> Delivery()
    {
        ...
        var model = await _checkoutService.GetDeliverySelectionAsync(GetCurrentUserId(), deliveryAddress);
    ...
    public async Task<IActionResult> Delivery(DeliverySelectionViewModel model)
    {
        ...
        if (!ModelState.IsValid || !_checkoutService.IsValidDeliveryMethod(model.SelectedDeliveryMethod))
        {
            ...
            var refreshed = await _checkoutService.GetDeliverySelectionAsync(GetCurrentUserId(), deliveryAddress);
    ...
    {
        var model = await _checkoutService.GetOrderResultAsync(GetCurrentUserId(), orderId);
